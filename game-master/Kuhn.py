...
class KuhnGame:
    ...
    # bids = np.array([-1, -1]),
    # quitnp.array([0, 0]))
    def genGame(self, parhists, hacts, parisets, iacts, depth, privatecard, publiccard, bids, quit, isTerminal=False,
                player=2):
        x, y = parhists.shape
        ...
        if obs[0] == False:
            ...
            self.genGame(nxtparhist, nxthacts, nxtpariset, nxtiacts, depth + 1, nxtprivatecard, nxtpubliccard, nxtbid,
                         nxtquit, isTerminal=False, player=0)
            ...
            self.genGame(nxtparhist, nxthacts, nxtpariset, nxtiacts, depth + 1, nxtprivatecard, nxtpubliccard, nxtbid,
                         nxtquit, isTerminal=False, player=2)
            ...
            for i in range(nacts):  # This will always be 2
                ...
                self.genGame(nxtparhist, nxthacts, nxtpariset, nxtiacts, depth + 1, nxtprivatecard, nxtpubliccard,
                             nxtbid, nxtquit, isTerminal=nxtisTerminal, player=nxtplayer)
